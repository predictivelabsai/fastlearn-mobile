  ...
  Future<void> _deleteAccount() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text(
          'This permanently deletes your account, chat history, favourites, '
          'saved searches, garage vehicles and profile preferences. This '
          'cannot be undone.',
        ),
        actions: [
          TextButton(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _sectionHeader('Delete account'),
          const SizedBox(height: 8),
          Text(
            'Permanently delete your CarHero account and all associated saved data.',
            style: TextStyle(
              fontSize: 14,
              color: AppTheme.gray500,
              height: 1.5,
