...
The initial release is intentionally safe and useful without mobile auth: native catalogue, curricula and Markdown lessons, plus local completion state. Secure account, quiz, XP, and AI tutor flows open `fastlearn.fun` in the browser.
